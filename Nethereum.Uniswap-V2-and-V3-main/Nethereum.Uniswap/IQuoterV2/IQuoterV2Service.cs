...
using Nethereum.Uniswap.IQuoterV2.ContractDefinition;

namespace Nethereum.Uniswap.IQuoterV2
{
    public partial class IQuoterV2Service
    {
        ...
        public Task<QuoteExactInputSingleOutputDTO> QuoteExactInputSingleQueryAsync(QuoteExactInputSingleFunction quoteExactInputSingleFunction, BlockParameter blockParameter = null)
        {
        ...
        public Task<QuoteExactInputSingleOutputDTO> QuoteExactInputSingleQueryAsync(QuoteExactInputSingleParams @params, BlockParameter blockParameter = null)
        {
