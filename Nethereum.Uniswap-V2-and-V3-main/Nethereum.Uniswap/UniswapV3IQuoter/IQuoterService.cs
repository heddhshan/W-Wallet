...
using Nethereum.Uniswap.Contracts.IQuoter.ContractDefinition;

namespace Nethereum.Uniswap.Contracts.IQuoter
{
    public partial class IQuoterService
    {
        ...
        public Task<string> QuoteExactInputSingleRequestAsync(string tokenIn, string tokenOut, uint fee, BigInteger amountIn, BigInteger sqrtPriceLimitX96)
        {
        ...
        public Task<TransactionReceipt> QuoteExactInputSingleRequestAndWaitForReceiptAsync(string tokenIn, string tokenOut, uint fee, BigInteger amountIn, BigInteger sqrtPriceLimitX96, CancellationTokenSource cancellationToken = null)
        {
            var quoteExactInputSingleFunction = new QuoteExactInputSingleFunction();
                quoteExactInputSingleFunction.TokenIn = tokenIn;
                quoteExactInputSingleFunction.TokenOut = tokenOut;
