...
{
    [Serializable]
    public class T_TranslationText
    {
        #region 生成该数据实体的SQL语句
        public const string SQL = @"Select Top(1) * From T_TranslationText";
        #endregion
        ...
        public T_TranslationText()
        {
        }


        public T_TranslationText(System.String AOriginalHash, System.String ALanCode)
        {
        ...
        public static T_TranslationText DataRow2Object(System.Data.DataRow dr)
        {
            if (dr == null)
            {
                return null;
            }
            T_TranslationText Obj = new T_TranslationText();
        ...
        public static List<T_TranslationText> DataTable2List(System.Data.DataTable dt)
        {
            List<T_TranslationText> result = new List<T_TranslationText>();
            foreach (System.Data.DataRow dr in dt.Rows)
            {
                result.Add(T_TranslationText.DataRow2Object(dr));
            }
            return result;
        }
        ...
        private static T_TranslationText _NullObject = null;

        public static T_TranslationText NullObject
        {
            get
            {
                if (_NullObject == null)
                {
                    _NullObject = new T_TranslationText();
                }
                return _NullObject;
            }
        }
