...
{
    [Serializable]
    public class T_OriginalText
    {
        #region 生成该数据实体的SQL语句
        public const string SQL = @"Select Top(1) * From T_OriginalText";
        #endregion
        ...
        public T_OriginalText()
        {
        }


        public T_OriginalText(System.String AOriginalHash)
        {
        ...
        public static T_OriginalText DataRow2Object(System.Data.DataRow dr)
        {
            if (dr == null)
            {
                return null;
            }
            T_OriginalText Obj = new T_OriginalText();
        ...
        public static List<T_OriginalText> DataTable2List(System.Data.DataTable dt)
        {
            List<T_OriginalText> result = new List<T_OriginalText>();
            foreach (System.Data.DataRow dr in dt.Rows)
            {
                result.Add(T_OriginalText.DataRow2Object(dr));
            }
            return result;
        }
        ...
        private static T_OriginalText _NullObject = null;

        public static T_OriginalText NullObject
        {
            get
            {
                if (_NullObject == null)
                {
                    _NullObject = new T_OriginalText();
                }
                return _NullObject;
            }
        }
